...
our %patron = ( 
	name => 'John or Jane Q. Patron',
	id => undef,
	password => undef,
	address => 'Not Really Here',
	home_phone => '250-256-1212',
	email_addr => 'fake@bclibrary.ca',
	charge_ok => 0,
	renew_ok => 0,
	recall_ok => 0,
	hold_ok => 0,
...
sub check_password {
	...
	return 1;
	# (!$self->{password} || ($pwd && ($self->{password} eq $pwd)));
}
